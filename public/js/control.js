...
var control1 = {
	...
	"<div class=\"col-3\"></div> "+ 
	"<div class=\"col-6\">" + "<b> Please take your time to read each sentence slowly and carefully in your mind. After you read each paragraph, pause for a minute to imagine the scene. </b>" + 
	...
	"<br></br><b> What is the name of a detective? </b>" + "<div class=\"row\">"
	}], 
...
var control2 = {
	...
	"<div class=\"col-6\">" + "<p>The captain set the sails at every opportunity, and the Rangoon, under these circumstances, made rapid progress. But in very rough weather extra precautions were necessary, and steam had to be reduced. This delay did not appear to affect Phileas Fogg in the least, but it worried Passe-partout tremendously. He swore at the captain, the engineers, and the company, and consigned all concerned to a warmer climate than Hong Kong. Perhaps the thought of the gas that was still burning in his room in London may have had something to do with his impatience.</p>" + 
		...
		"<p>This remark rather disturbed Fix, without his knowing why. Could the Frenchman have discovered who he was? He did not know what to do. But how could Passe-partout have found out his real object? And yet in speaking as he did, Passe-partout must certainly have had some ulterior motive. </p>" + 
		"<br></br><b> How did weather in Hong Kong compare to London? <b/>"+ "<div class=\"row\"> "
	}], 
	preamble: "<h1>Control</h1>", 
	button_label: 'Next',
	post_trial_gap: 1000, 
...
var control4 = {
	...
	"<p> One day he was contemplating the working of the machinery, when a pitch of the vessel threw the screw out of the water. The steam roared through the valves, and Passe-partout exclaimed, indignantly: 'The escape valves are not sufficiently charged! We make no way! That is English all over. Ah! if this were only an American ship—we might blow up, perhaps, but at any rate we should go quicker meantime.' </p>" +
	"<br></br><b> Come up with a question here <b/>"+ "<div class=\"row\"> "
	}], 
	preamble: "<h1>Control</h1>", 
	button_label: 'Next',
	post_trial_gap: 1000, 
