...
jsPsych.plugins['survey-debrief'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    // Item 4: Goal of task
    html += '<div class="survey-debrief-row">';
    html += '<div class="survey-debrief-prompt"><label for="goal">What do you think happened in the task?</label></div>';
    ...
    html += '</div>';
     ...
     // Item 7: Language
    html += '<div class="survey-debrief-row">';
    html += '<div class="survey-debrief-prompt"><label for="wordValues">Do you think the points associated with the words changed in the middle of the task?</label></div>';
    html += '<div class="survey-debrief-response">';
    html += '<label><input type="radio" name="wordValues" value="1" required>Yes</label><br>';
    html += '<label><input type="radio" name="wordValues" value="0" required>No</label><br>';
    html += '</div></div>';
