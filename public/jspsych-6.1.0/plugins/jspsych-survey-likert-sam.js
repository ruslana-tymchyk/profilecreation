...
jsPsych.plugins['survey-likert'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    html += ".jspsych-survey-likert-statement { display:block; font-size: 18px; padding-top: 36px; margin-bottom:10px; text-align:center}"+
      ".jspsych-survey-likert-opts { list-style:none; width:"+w+"; margin:auto; padding:0 0 36px; display:block; font-size: 16px; line-height:1.5em; }"+
