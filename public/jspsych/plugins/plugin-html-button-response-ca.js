  ...
  class HtmlButtonResponsePlugin {
      ...
      trial(display_element, trial) {
          ...
          function after_response(choice) {
              ...
              //HELP - selecting the right attirbure to outline the chosen button response
              display_element.querySelector(`div[data-choice="${choice}"]`).setAttribute("style","border:3px; border-style:solid; border-color:#000000; background-color:red;");   
